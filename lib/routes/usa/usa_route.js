...
module.exports = {
  ...
  handler: async (req, h) => {
    ...
    // and finally utilize the citiesQuery() method we created when we created the usaService subclass, this will call the Objection query() call which also includes withGraphFetched() to attach country information
